...
import { useUpdateOrderStatusMutation, useUpdateStatusPaymentOrderMutation } from "../../../services/order";
              ...
              <div className="orderPay-paymentMethods-money-box">
                ...
                <div className="orderPay-paymentMethods-money-box-pay">
                  {data.status.id === 1 && (
                    <>
                     <Popconfirm
                        onConfirm={() => confirm(3, "Đơn hàng đã được xác nhận")}
                  ...
                  {data.status.id === 2 && (
                    <>
                     <Popconfirm
                        onConfirm={() => confirm(3, "Đơn hàng đang được giao tới khác hàng")}
                  ...
                  {data.status.id === 3 && (
                    <>
                      ...
                      <Popconfirm
                        onConfirm={() => confirm(6, "Xác nhận thành công người nhận trả hàng")}
