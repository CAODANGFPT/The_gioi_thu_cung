...
export const create = async (req, res) => {
  try {
    const { logo, email, phone, logo_res, fb, zalo } = req.body;
    const website_informationId = await WebsiteInformation.createWebsiteInformation(logo, email, phone, logo_res, fb, zalo);
...
export const update = async (req, res) => {
  try {
    const { id, logo, email, phone, logo_res, fb, zalo } = req.body;
    await WebsiteInformation.updateWebsiteInformation(id, logo, email, phone, logo_res, fb, zalo);
