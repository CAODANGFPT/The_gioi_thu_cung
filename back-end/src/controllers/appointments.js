...
export const show = async (req, res) => {
    try {
        const appointmentsItem = await Appointments.getAppointmentsById(req.params.id);
        if (!appointmentsItem) {
...
export const create = async (req, res) => {
    try {
        const { day, pet_id, services_id, user_id, pethouse_id, time_id } = req.body;
        ...
        const appointmentsId = await Appointments.createAppointments(day, pet_id, services_id, user_id, pethouse_id, time_id);
...
export const update = async (req, res) => {
    try {
        ...
        await Appointments.updateAppointments(req.params.id, day, pet_id, services_id, user_id, pethouse_id, time_id);
